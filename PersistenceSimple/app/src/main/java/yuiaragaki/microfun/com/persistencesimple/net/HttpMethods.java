...
//    public static final String BASE_URL = "https://api.douban.com/v2/movie/";
    public static final String BASE_URL = "https://api.douban.com/v2/book/isbn/";
...
//        movieService = retrofit.create(MovieService.class);
        bookService = retrofit.create(MovieService.class);
    }
...
//    }
    ...
    public void getBookWithISBN(Subscriber<Book> subscriber, String isbn)
    {
        bookService.getBookWithISBN(isbn)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(subscriber);
    }
